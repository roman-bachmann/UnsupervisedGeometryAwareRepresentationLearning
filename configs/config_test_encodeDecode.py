...
if 0:
    network_path = './output/trainNVS_resL3_ResNet_layers4_implRFalse_s3Dp[1_9_11]_w3Dp0_w3D0_wRGB1_wGrad0_wImgNet2_skipBG0_fg128_3dTrue_lh3Dp2_ldrop0o3_billinupper_fscale2_shuffleFGTrue_shuffle3dTrue_h36m_nth1_cFalse_sub[1_5_6_7_8]_bs2_lr0o001_vaeFalse'
    config_dict['pretrained_network_path'] = network_path + '/models/network_best_val_t1.pth'
if 1:
    network_path = './output/trainNVS_resL3_ResNet_layers4_implRFalse_s3Dp[1_9_11]_w3Dp0_w3D0_wRGB1_wGrad0_wImgNet2_skipBG0_fg128_3dTrue_lh3Dp2_ldrop0o3_billinupper_fscale2_shuffleFGTrue_shuffle3dTrue_h36m_nth1_cFalse_sub[1_5_6_7_8]_bs2_lr0o001_vaeFGTrue_vae3dTrue_kl0o01_'
    config_dict['pretrained_network_path'] = network_path + '/models/network_best_val_t1.pth'
else:
